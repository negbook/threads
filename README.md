...
For better perfromances with drawing-natives.Using 'Threads' Lib!  
...
Threads.CreateLoop("Check",0,function(Break,name)
    print(name)
end)
Threads.CreateLoop("Check2",1000,function(Break,name,total)
    print(name,total)
...
Threads.CreateLoopCustom("CheckCustom",3000,function(delay,Break)
    print("hhhh4")
    delay.setter(1500)
end)
Threads.CreateLoopCustom("CheckCustomGetSet",3000,function(delay,Break,name,total)
