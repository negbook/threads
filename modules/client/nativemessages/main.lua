...
local coordsmessage = function(text,coords,duration,cb)
    ...
    if bool then 
        ...
        Threads.TweenCFX.to(object,durationIn,{_alpha=255,ease=Threads.TweenCFX.Ease.LinearNone,onCompleteScope=function(object,coordsmessage_handle,cb)
            --Threads.TweenCFX.delayCall(object,durationHold,{_alpha=0,ease=Threads.TweenCFX.Ease.LinearNone,onCompleteScope=function(object,coordsmessage_handle,cb)
                Threads.TweenCFX.to(object,durationOut,{_alpha=0,ease=Threads.TweenCFX.Ease.LinearNone,onCompleteScope=function(object,coordsmessage_handle,cb)
        ...
        coordsmessage_handles[coordsmessage_handle] = true 
        Threads.CreateLoop("coordsmessage"..coordsmessage_handle,0,function(Break)
            if coordsmessage_handles[coordsmessage_handle] then 
